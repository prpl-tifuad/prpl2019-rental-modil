...
<div id="frame-faktur">
	...
	<table class="table-list">
		...
		<tr class="baris-title">
			<th class="no">No</th>
			<th class="kiri">Nama Mobil</th>
			<th class="tengah">Hari</th>
			<th class="kanan">Harga Per hari</th>
		...
		<tr>
			<td class="kanan" colspan="4">Biaya Pemesanan</td>
	...
	<div id="frame-keterangan-pembayaran">
		<p>Silahkan Lakukan pembayaran ke Bank ABC<br/>
		   Nomor Account : 0000-9999-8888 (A/N Rental Mobil).<br/>
